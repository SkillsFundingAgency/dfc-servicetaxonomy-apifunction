...
WHERE s.uri in ['http://data.europa.eu/esco/skill/9436db78-4331-495b-a97d-223fd246de2f'] WITH soc, o, s, r, collect({name:jc.skos__prefLabel,uri:'testhost.com' + jc.WebsiteURI}) as JobCategories
...
WITH soc, o, s, st, sm, rrl, srl, r, collect(
{
	...
	skillReusability:case srl.skos__prefLabel
	...
	lastModified:head(sx.dct__modified)}) as MatchingOptionalSkills, MatchingEssentialSkills 
...
WITH o, collect(
{
	...
	lastModified:head(sa.dct__modified) }) as AllOptionalSkills, AllEssentialSkills, soc, MatchingOptionalSkills,MatchingEssentialSkills, JobProfile, JobProfileUri, JobProfileDescription 
RETURN 
{ 
